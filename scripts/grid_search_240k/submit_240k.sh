...
SLURM_SCRIPT=run_beta_to_episcore_240k.slurm
...
SLEEP_BETWEEN=0.5       # seconds between consecutive sbatch calls
...
for thres in "${THRESHOLDS[@]}"; do
    ref_dir="${RESULT_BASE}/threshold_${thres}/240k_early_ref_n_16"
    analyze_dir="${RESULT_BASE}/threshold_${thres}/240k_analyze_n_26"
