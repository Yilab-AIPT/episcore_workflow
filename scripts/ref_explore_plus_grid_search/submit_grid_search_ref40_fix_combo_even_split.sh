#!/usr/bin/bash
# Submit random ref-40 grid search: split-mode=even_split, combo-mode=fix.
#
# Usage:
#     ./submit_grid_search_ref40_fix_combo_even_split.sh [-n|--dry-run]
#
# Defaults:
#     output_base   : /lustre1/cqyi/AIPT_2.0/results/episcore_output/20260626-ref_40_fixed_combo_even_split
#     total_repeats : 10000
#     min-ff        : 0.01
