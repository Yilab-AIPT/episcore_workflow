#!/usr/bin/bash
# Submit a single SLURM job that runs b2z_for_global_recall.py.
#
...
#
# Usage:
#     ./submit_for_global_recall.sh [-n|--dry-run] \
...
SLURM_SCRIPT=run_b2z_for_global_recall.slurm
JOB_NAME=b2z_global_recall
